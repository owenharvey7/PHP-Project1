...
if (isset($_POST['submit-button'])) {
    ...
    //table to display the car information
    ...
    if($result->rowCount() > 0) {
        ...
        //private owner value).
        echo "<div style=\"text-align: center;\"><h4>Car Values Depending on Vendor:</h4></div>";

        $privateOwner = $basePrice * 1.15;
        $suggestedRetail = $basePrice;
        $certifiedPreOwned = $basePrice * 1.25;
